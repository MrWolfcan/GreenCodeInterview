...
describe("Pro license pricing/order form tests: ", function () {
    ...
    it("(1year) Check if the button redirects on expected URL: ", async function () {
        await buttonRedirect(12, 'price-pro-purchase', 'pro');
    });
